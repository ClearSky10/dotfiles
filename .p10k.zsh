# Generated by Powerlevel10k configuration wizard on 2020-04-09 at 15:27 +05.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 33563.
# Wizard options: awesome-fontconfig + powerline, small icons, lean_8colors, time,
# 2 lines, dotted, blue-ornaments, sparse, concise, transient_prompt,
